...
# ============================================================================
# This script deploys the performance optimizations to the production server
# including database migrations, seeders, and cache clearing.
# ============================================================================
...
# Step 2: Seed default events (templates)
