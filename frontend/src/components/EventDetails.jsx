              ...
              : event.is_open
                ...
                : event.is_default_event
                  ...
                  : currentUser && event.host.id === currentUser.id
                    ? 'bg-gray-50 border-gray-100 hover:bg-green-100/50 hover:border-green-300 hover:shadow-md'
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {currentUser && event.host.id === currentUser.id && !event.is_default_event && (
                    <span className="flex-shrink-0 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-green-100 text-green-700 border border-green-200">
                      Owner
                    </span>
                  )}
                  {event.is_default_event && (
                ...
                {/* Show date range for academic events with end_date */}
            ...
            {currentUser && event.host.id === currentUser.id && !event.is_default_event && (
              <div className="flex space-x-2 mt-3 pt-3 border-t border-gray-200/60">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-green-800 bg-green-100 rounded-lg hover:bg-green-200 transition-colors shadow-sm hover:shadow-md"
                >
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-red-700 bg-red-50 rounded-lg hover:bg-red-100 transition-colors shadow-sm hover:shadow-md"
                >
                  <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
