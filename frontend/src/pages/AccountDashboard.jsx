    ...
    <div ref={ref} className="relative inline-block">
      <div className="flex items-center border border-green-400 rounded-lg focus-within:ring-2 focus-within:ring-green-600 bg-white">
        <input
          ...
          onBlur={handleBlur}
          className="pl-1 sm:pl-2 pr-0.5 sm:pr-1 py-1 sm:py-1.5 text-xs sm:text-sm w-[4.5rem] sm:w-24 focus:outline-none bg-transparent"
        />
        <button
          tabIndex={-1}
          onMouseDown={e => { e.preventDefault(); open ? setOpen(false) : openDropdown(); }}
          className="pl-0.5 sm:pl-1 pr-1 sm:pr-1.5 text-green-500 hover:text-green-700"
        >
      ...
      <main className={`w-full py-8 sm:px-6 lg:px-8`}>
        <div className="px-4 py-2 sm:px-0">
          ...
          <div className="mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-1">Account Dashboard</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium">Manage your account information and settings</p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-8">
                ...
                <div className="lg:col-span-3">
                  <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-visible hover:shadow-xl transition-shadow duration-300 h-full">
                    <div className="bg-gradient-to-r from-green-700 via-green-600 to-green-800 px-4 sm:px-8 py-4 sm:py-6 flex justify-between items-center">
                      <div>
                        <h3 className="text-lg sm:text-2xl font-bold text-white flex items-center gap-2">
                          ...
                          {!user?.schedule_initialized && !scheduleSaving && (
                            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-white/20 text-white animate-pulse">
                          ...
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-white/10 text-white/90">
                            <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p className="text-green-200 text-xs sm:text-sm mt-1">
                          {scheduleLoading ? 'Loading...' : user?.schedule_initialized
                            ? `${getTotalScheduledClasses()} classes this week • ${currentSemester.period}`
                            : `No schedule set • ${currentSemester.period}`}
                        </p>
                      </div>
                        ...
                        {scheduleEditMode ? (
                          <>
                            <button
                              ...
                              className={`px-2 sm:px-4 py-1.5 sm:py-2 text-white text-xs sm:text-sm font-semibold rounded-lg transition-all duration-200 shadow-md flex items-center gap-1.5 ${scheduleSaving
                            ...
                            <button
                              ...
                              disabled={scheduleSaving}
                              className="px-2 sm:px-4 py-1.5 sm:py-2 bg-white/20 hover:bg-white/30 text-white text-xs sm:text-sm font-semibold rounded-lg transition-all duration-200 shadow-md flex items-center gap-1.5"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="p-6">
                      ...
                      {scheduleLoading ? (
                        ...
                        <div className="flex gap-3 sm:gap-6">
                          ...
                          <div className="flex flex-col gap-1.5 sm:gap-2 min-w-[90px] sm:min-w-[110px]">
                            {days.map(day => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`px-2 sm:px-3 py-2 sm:py-2.5 rounded-lg font-semibold text-left transition-all duration-200 flex justify-between items-center text-xs sm:text-sm ${isSelected
                                    ? 'bg-gradient-to-r from-green-600 to-green-700 text-white shadow-md'
                                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                    }`}
                                >
                                  <span>{day}</span>
                                  <span className={`text-xs px-1.5 py-0.5 rounded-full font-bold ${isSelected ? 'bg-white/20 text-white' : 'bg-green-200 text-green-700'
                                    }`}>
                                    {daySchedule.length}
                                  </span>
                                </button>
                          ...
                          <div className="flex-1 bg-green-100 border-2 border-green-300 rounded-lg p-3 sm:p-6 min-w-0">
                            <div className="flex justify-between items-center mb-3 sm:mb-4">
                              <h4 className="text-base sm:text-xl font-bold text-gray-900">{selectedDay} Schedule</h4>
                              {scheduleEditMode && (
                                <button
                                  onClick={() => addNewClass(selectedDay)}
                                  className="px-2 sm:px-3 py-1 sm:py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs sm:text-sm font-semibold rounded-lg transition-all duration-200 flex items-center gap-1"
                                >
                                ...
                                <table className="w-full">
                                  <thead>
                                    <tr className="bg-green-200">
                                      <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-bold text-gray-900 whitespace-nowrap w-[5.5rem] sm:w-auto">
                                        Time Range
                                      </th>
                                      <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-bold text-gray-900">
                                        Class Description
                                      </th>
                                      {scheduleEditMode && (
                                        <th className="px-1 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-bold text-gray-900 w-12 sm:w-20">
                                          Action
                                        </th>
                                      )}
                                    </tr>
                                        ...
                                        <td className="px-2 sm:px-4 py-2 sm:py-3">
                                          {scheduleEditMode ? (
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-2">
                                              ...
                                              />
                                              <span className="hidden sm:inline text-gray-500 font-bold">-</span>
                                              <TimePickerInput
                                                value={slot.endTime}
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-0.5 sm:gap-1 text-gray-900 font-medium text-xs sm:text-base leading-tight whitespace-nowrap">
                                              <svg className="hidden sm:block w-4 h-4 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                              </svg>
                                              <span>{formatTime12Hour(slot.startTime)}</span>
                                              <span className="hidden sm:inline text-gray-400 sm:text-gray-900 mx-1">–</span>
                                              <span>{formatTime12Hour(slot.endTime)}</span>
                                            </div>
                                          )}
                                        </td>
                                        <td className="px-2 sm:px-4 py-2 sm:py-3">
                                          {scheduleEditMode ? (
                                            <textarea
                                              ...
                                              className="w-full h-14 sm:h-10 px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-green-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 resize-none min-h-[3.5rem] sm:min-h-0"
                                            />
                                          ) : (
                                            <div className="text-xs sm:text-base text-gray-900 leading-tight">{slot.description || <span className="text-gray-400 italic">No description</span>}</div>
                                          )}
                                        </td>
                                        {scheduleEditMode && (
                                          <td className="px-1 sm:px-4 py-2 sm:py-3 text-center">
                                            <button
                                              ...
                                              className="p-1 sm:p-1.5 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200"
                                              title="Remove class"
                                            >
                  ...
                  <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full">
                    ...
                    <div className="px-5 py-6 sm:px-8 sm:py-8">
                      {editMode ? (
                        ...
                        <div className="space-y-6">
                          <div className="flex flex-col items-center pb-4 sm:pb-6 border-b border-gray-200">
                            {user?.profile_picture ? (
                              <img src={user.profile_picture} alt={user?.username} className="w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-green-200 shadow-lg" />
                            ) : (
                              <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-green-300 to-green-600 rounded-full flex items-center justify-center text-white font-bold text-3xl sm:text-4xl shadow-lg">
                                {user?.username?.charAt(0).toUpperCase()}
                              </div>
                            )}
                          ...
                          <div className="pb-4 sm:pb-6 border-b border-gray-200">
                            ...
                            <p className="text-base sm:text-lg text-gray-900 font-medium">February 2026</p>
                          </div>
                          <div className="pb-4 sm:pb-6 border-b border-gray-200">
                            <p className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">Email Address</p>
                            <p className="text-base sm:text-lg text-gray-900 font-medium">{user.email}</p>
                          </div>
                          <div className="pb-4 sm:pb-6 border-b border-gray-200">
                            <p className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">Department</p>
                            <p className="text-base sm:text-lg text-gray-900 font-medium">{user.department || 'Not specified'}</p>
                          </div>
                          <button
                            onClick={() => setEditMode(true)}
                            className="mt-6 sm:mt-8 w-full px-6 py-3 bg-gradient-to-r from-green-700 to-green-800 text-white font-semibold rounded-lg hover:from-green-800 hover:to-green-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 transition-all duration-300 shadow-lg hover:shadow-xl"
                          >
                            Edit Profile
                          </button>
                        </div>
